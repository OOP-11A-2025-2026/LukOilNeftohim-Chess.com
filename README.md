...
> [!NOTE]
>
> Използването на терминал, който поддържа 24-bit ANSI цветове, е **задължително** за правилно изобразяване.
...
> [!NOTE]
>
>  Всички .java файлове са в `src/`, изходните `.class` файлове се записват в `out/`, а библиотеки се търсят в `lib/`.
